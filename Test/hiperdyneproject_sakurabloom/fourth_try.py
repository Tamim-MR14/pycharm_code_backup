...
for m in p:
    for i in train_df[train_df.year == train_years[m]].serial:
        datanow[0] = datanow[0] + train_df.get_value(i, 'avg temp')
        datanow[1] = datanow[1] + train_df.get_value(i, 'avg humid')
        datanow[2] = datanow[2] + train_df.get_value(i, 'min humid')
        datanow[3] = datanow[3] + train_df.get_value(i, 'sun hours')
...
for m in p:
    for i in test_df[test_df.year == test_years[m]].serial:
        datanow[0] = datanow[0] + test_df.get_value(i, 'avg temp')
        datanow[1] = datanow[1] + test_df.get_value(i, 'avg humid')
        datanow[2] = datanow[2] + test_df.get_value(i, 'min humid')
        datanow[3] = datanow[3] + test_df.get_value(i, 'sun hours')
...
print(mlp.score(train_data, train_target))
print(mlp.score(test_data, test_target))

pred_day = mlp.predict(test_data)
print(test_target)
